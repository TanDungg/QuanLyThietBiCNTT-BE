...
function LoaiThietBi({ history, permission }) {
  ...
  useEffect(() => {
    function load() {
      dispatch(fetchStart("LoaiThietBi", "GET", null, "LIST"));
    }
  ...
  const deleteItemAction = (item) => {
    let url = `LoaiThietBi/${item.id}`;
    if (item.isRemove) url = `LoaiThietBi/Remove/${item.id}`;
